...
export interface IAuthService {
  ...
  forgotPassword(data: IForgotPasswordRequest): Promise<IApiResponse<null>>;
  resetPassword(
...
export interface IFormFieldProps extends Omit<
...
export interface IPasswordFieldProps extends Omit<IFormFieldProps, "type"> {
  type?: never;
}
