...
export function TermsAndConditionsModal({
  ...
  return (
    <Modal
      eyebrow={'Versión ' + TERMS_VERSION + ' · Vigente desde ' + EFFECTIVE_DATE}
      title="Términos y privacidad"
      onClose={onClose}
    >
      <div className="mb-6 flex gap-3 rounded-2xl border border-moss/20 bg-moss/8 p-4 text-sm leading-6 text-forest">
      ...
      <div className="space-y-6 text-sm leading-6 text-ink/70">
        <section>
          <h3 className="mb-2 font-bold text-forest">1. Aceptación y alcance</h3>
          <p>
        ...
        <section>
          <h3 className="mb-2 font-bold text-forest">
          ...
          <p>
            ...
            no reemplazan asesoramiento financiero, contable, impositivo o
            legal profesional.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Tratamos tu nombre, correo electrónico, credenciales protegidas y
            la información financiera que ingreses, como ahorros, ingresos,
        ...
        <section>
          ...
          <p>
            Esta versión base se interpreta conforme a las leyes de la
            República Argentina. La jurisdicción y los datos completos del
            responsable deberán definirse antes del lanzamiento público.
          </p>
        </section>
      </div>

      <div className="mt-7 flex items-start gap-3 rounded-2xl bg-forest p-4 text-sm text-white/75">
        <ShieldCheck className="mt-0.5 shrink-0 text-lime" size={18} />
        <p>
      ...
      <button
        type="button"
        onClick={onClose}
        className="mt-6 w-full rounded-2xl bg-forest px-5 py-3 text-sm font-bold text-white transition hover:bg-moss"
      >
        Entendido
      </button>
    </Modal>
