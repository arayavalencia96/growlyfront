    ...
    <div>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-1/2 right-3 grid size-9 -translate-y-1/2 place-items-center rounded-lg text-body/45 transition hover:bg-brand/5 hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-moss"
